...
## Milestone 0 — Scaffold & data model
- Shared model schemas (Project, Floorplan, SceneGraph)
- Op-log events + merge rules
...
- 3D reconstruction
- Furniture placement + gizmos
- AR placement

## Milestone 3 — Sync + collaboration
- Offline-first sync
...
- AI suggestions + layout generation
